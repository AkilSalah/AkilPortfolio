  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/logoAkil.png" width={250} alt="AkilLogo" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
              <a
                href="https://www.instagram.com/akil_salah/"
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/akilsalaheddine/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Akil SalahEddine</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
